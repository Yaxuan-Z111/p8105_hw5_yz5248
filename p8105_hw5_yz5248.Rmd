...
When effect size equals to 0 the power is very low (close to the significance level, around 0.05–0.1), meaning the test rarely rejects the null hypothesis when it is true.  
